...
class MkTestType(models.Model):
    ...
    test_scope = fields.Selection([('a','All Quran'),('s','Specific Parts'),('e','Ending')],string='Test Scope')
    ...
    def fields_view_get(self, view_id=None, view_type=False, context=None, toolbar=False, submenu=False):
        res = super(MkTestType, self).fields_view_get(view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=submenu)
