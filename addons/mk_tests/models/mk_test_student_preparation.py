...
class MkTestStudentPreparation(models.Model):
    ...
    _rec_name = 'test_registeration_id'
    ...
    std_id = fields.Many2one('mk.link', string='Student')
    #mosq_id = fields.Many2one('mk.mosque', string='Mosque')
