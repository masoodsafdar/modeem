...
class FinishedSupervisorRequestReportXlsx(models.AbstractModel):
    _inherit = 'report.report_xlsx.abstract'
    _name = 'report.mk_episode_management.super_req_finished_excel_report'
    ...
    def generate_xlsx_report(self, workbook,  data, docids):
        ...
        def _header_sheet(sheet):
            sheet.write(0, 3, _('تقرير التكاليف المنتهية '), report_format)
        ...
        sheet = workbook.add_worksheet('تقرير التكاليف المنتهية ')
        head = [
            {'name': 'المركز',
             'larg': 20,
             'col': {}},
