...
class AlmostFinishedPermissionReportXlsx(models.AbstractModel):
    _inherit = 'report.report_xlsx.abstract'
    _name = 'report.mk_episode_management.almost_finished_perm_excel_report'
    ...
    def generate_xlsx_report(self, workbook,  data, docids):
        ...
        def _header_sheet(sheet):
            sheet.write(0, 3, _('تقرير التصاريح المقاربة للنهاية (3 أشهر وأقل) '), report_format)
        ...
        sheet = workbook.add_worksheet('تقرير التصاريح المقاربة للنهاية (3 أشهر وأقل)')
        head = [
            {'name': 'المركز',
             'larg': 20,
             'col': {}},
